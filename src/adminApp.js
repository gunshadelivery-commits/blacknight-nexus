...
function toggleProductModal(show, mode = 'add', type = 'herb') { 
    ...
    if (!isEditMode) {
        ...
        if (type === 'herb') categorySelect.value = "ผลิตภัณฑ์เพื่อสุขภาพ";
        else categorySelect.value = "ของเล่น";
...
function editProduct(name) {
    ...
    document.getElementById('pCategory').value = base.category || "ผลิตภัณฑ์เพื่อสุขภาพ";
